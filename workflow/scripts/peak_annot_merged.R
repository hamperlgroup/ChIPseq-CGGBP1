...
if (!dir.exists(paste0(roothPath, "/results/ChIP-peaks/", peakMode, "/merged/peak_annotation"))) {
    dir.create(paste0(roothPath, "/results/ChIP-peaks/", peakMode, "/merged/peak_annotation"))
}

outDir <- paste0(roothPath, "/results/ChIP-peaks/", peakMode, "/merged/peak_annotation")
