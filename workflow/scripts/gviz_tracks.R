...
bg_encode_track <- DataTrack(range = bg_encode, type = "hist", genome = "hg38", name = "ChIP-seq CGGBP1", col.histogram = "darkblue", fill.histogram = "darkblue", ylim = c(0, 0.6))
...
bg_ctrl_track <- DataTrack(range = bg_ctrl, type = "hist", genome = "hg38", name = "ChIP-seq CGGBP1 control", col.histogram = "darkblue", fill.histogram = "darkblue", ylim = c(0, 0.6))
...
# Load the BigWig file
bg_encode <- "/lustre/groups/ies/projects/hamperl_lab/elizabeth.marquezgom/Augusto/ChIPseq-CGGBP1/results/covmean/ChIP-seq_CGGBP1_ENCODE.coverage.bedgraph"
bg_encode_track <- DataTrack(range = bg_encode, type = "hist", genome = "hg38", name = "ChIP-seq CGGBP1", col.histogram = "darkblue", fill.histogram = "darkblue", ylim = c(0, 0.9))

bg_ctrl <- "/lustre/groups/ies/projects/hamperl_lab/elizabeth.marquezgom/Augusto/ChIPseq-CGGBP1/results/covmean/ChIP-seq_ctrl.coverage.bedgraph"
bg_ctrl_track <- DataTrack(range = bg_ctrl, type = "hist", genome = "hg38", name = "ChIP-seq CGGBP1 control", col.histogram = "darkblue", fill.histogram = "darkblue", ylim = c(0, 0.9))
